...
class EditTextName: AppCompatEditText, View.OnTouchListener {
    ...
    private fun init() {
        clearButton = ContextCompat.getDrawable(context, R.drawable.ic_baseline_close_24) as Drawable // x button
        ...
        addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable) {
                ...
                if (s.toString().isEmpty()) showButtonError()
            }
        })
    }

    private fun showButtonError() {
        error = context.getString(R.string.filled_first)
    }
